// components/SinglePlayerCoverLossModal.tsx
import React, { useState } from 'react';
import { Player } from '../lib/types';
import styles from './Modal.module.css';

interface SinglePlayerCoverLossModalProps {
  player: Player;
  lossAmount: number;
...
const SinglePlayerCoverLossModal: React.FC<SinglePlayerCoverLossModalProps> = ({ player, lossAmount, targetCategory, onSubmit }) => {
...
export default SinglePlayerCoverLossModal;