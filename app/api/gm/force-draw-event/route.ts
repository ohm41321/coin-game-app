// app/api/gm/force-draw-event/route.ts
...
export async function POST() {
  try {
    ...
    const updatedState = await updateGameState((currentState) => {
      ...
      // For players who haven't submitted, their currentAllocation will remain null.
      // This will cause them to be skipped in the round calculation as requested.
      eventDrawn = true;
    ...
    console.error('Force Draw Event Error:', error);
